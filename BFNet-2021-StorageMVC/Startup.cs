...
namespace BFNet_2021_StorageMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(new BlobStorageService(Configuration.GetConnectionString("AccessKey")));
            services.AddSingleton<UserRepository>(new UserRepositoryImpl(Configuration.GetConnectionString("AccessKey")));
